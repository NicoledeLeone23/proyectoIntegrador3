...
class PeliculasCartelera extends Component {
  ...
  componentDidMount() {
    fetch(
      "https://api.themoviedb.org/3/movie/now_playing?api_key=0504f3c6e1a5148aa088833579916ded&language=es-ES&page=1"
    )
  ...
  render() {
    ...
    return (
      <section className="cardContainer cartelera">
        ...
        <Link className="see-all" to="/peliculasencartel">
          Ver todas
        </Link>
      </section>
    );
